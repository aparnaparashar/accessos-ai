 ...
 * icons (hearing / vision / motor / mobility).
 * Clicking each icon deep-links directly to that feature in the Features page.
 */
@Component({
  ...
  template: `
    <aside class="rail" aria-label="Accessibility capability categories">
      <a routerLink="/features" [queryParams]="{ feature: 'sign' }" fragment="sign" class="rail-item" title="Hearing &amp; Sign Language">
      ...
      <a routerLink="/features" [queryParams]="{ feature: 'vision' }" fragment="vision" class="rail-item" title="Vision &amp; Scene Understanding">
      ...
      <a routerLink="/features" [queryParams]="{ feature: 'simplify' }" fragment="simplify" class="rail-item" title="Motor &amp; Text Simplification">
      ...
      <a routerLink="/features" [queryParams]="{ feature: 'accessibility' }" fragment="accessibility" class="rail-item" title="Navigation &amp; Mobility">
